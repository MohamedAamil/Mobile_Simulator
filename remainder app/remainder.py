...
layout=[
    [sg.Text("Enter Task:",font=("Verdana",14),pad=((30,15),(0,0))),sg.InputText("",font=("Verdana",14),pad = (10,20) ,size=(20,1),key="taskname"),
     sg.Button("Open",font=("Verdana",12),pad=(15,0),size=(10,0),key="open_work")],
     [sg.Button("Add",font=("Verdana",12),pad = (15,5),size=(10,0),key="add_work"),
      sg.Button("Edit",font=("Verdana",12),pad = (20,5),size=(10,0),key="edit_work"),
     sg.Button("Delete",font=("Verdana",12),pad = (20,5),size=(10,0),key="delete_work"), sg.Button("Completed",font=("Verdana",12),pad = (15,5),size=(10,0),key="complete_work")],
      [sg.Text("Priority:",font=("Verdana",14),pad=((60,7),(20,20))),sg.InputCombo(['Very High','High','Low'],size=(9,0),key="drop_down"),sg.Text("Date:",font=("Verdana",12),pad=((70,7),(20,20))),sg.InputText("",font=("Verdana",12),size=(9,1),key="dated")],
     [sg.Listbox(values=[],font=("Verdana",14),size=(30,10),pad = (15,10),select_mode='single',change_submits=True,key="list_box"),
    sg.Listbox(values=[],font=("Verdana",14),size=(10,10),pad = (10,10),select_mode='single',change_submits=True,key="date_box")],
    
    [sg.Button("Show completed tasks",font=("Verdana",12),key="show_work")]]
